<?php
/**
 * CSortableCheckBoxColumn class file.
 *
/* 
...
/**
 * CSortableCheckBoxColumn represents a grid view column that renders a checkbox in each of its data cells.
 *
 * See CCheckBoxColumn for details about setting up this class.  In addition, to enable sorting the name property
 ...
 * @version $Id$
 */
class CSortableCheckBoxColumn extends CCheckBoxColumn {
